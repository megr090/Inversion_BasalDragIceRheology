...
load('InverseRestart.mat');
[txzb,tyzb,txx,tyy,txy,exx,eyy,exy,e,eta]= CalcNodalStrainRatesAndStresses(CtrlVar,MUA,F.AGlen,F.n,F.C,F.m,GF,F.s,F.b,Meas.us,Meas.vs,F.ud,F.vd);

e(abs(e)<5e-5)=5e-5;

% this began as gaC = 10; gsC = 1e6; gaA = 1e-1./e; gsA = 1e3./e;
% without SR on gradient: gaC=10; gsC=1e5; gaA=1e-1./e; gsA=1e4;

CtrlVar.Inverse.Regularize.Field=CtrlVar.Inverse.InvertFor;
CtrlVar.Inverse.Regularize.C.gs=1;
CtrlVar.Inverse.Regularize.C.ga=1;
CtrlVar.Inverse.Regularize.logC.ga=10;
CtrlVar.Inverse.Regularize.logC.gs=1e5; % 1e6  works well with I

CtrlVar.Inverse.Regularize.AGlen.gs=1;
CtrlVar.Inverse.Regularize.AGlen.ga=1;
CtrlVar.Inverse.Regularize.logAGlen.ga=1e-2./e;
CtrlVar.Inverse.Regularize.logAGlen.gs=1e2./e;
